...
void main() {
  ...
  Future<void> sendLikeNotification({
    ...
    await firestore.collection('users').doc(ownerUid).collection(
        'notifications').add({
      'type': 'amen',
  ...
  testWidgets(
    ...
    'author is notified, the Amen shows, and it can be undone', (tester) async {
      ...
      final notifications =
          await firestore.collection('users').doc('bob').collection(
              'notifications').get();
