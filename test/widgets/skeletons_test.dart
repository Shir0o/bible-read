...
void main() {
  group('Skeletons', () {
    testWidgets('GroupListSkeleton builds correctly', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: Scaffold(body: GroupListSkeleton())));
