...
void main() {
  group('FeedbackForm UX', () {
    testWidgets('Fields have correct configuration and clear buttons', (tester) async {
      ...
      expect(titleField.textCapitalization, TextCapitalization.sentences, reason: 'Title should capitalize sentences');
      ...
      expect(descField.textCapitalization, TextCapitalization.sentences, reason: 'Description should capitalize sentences');
      expect(descField.keyboardType, TextInputType.multiline, reason: 'Description should have multiline keyboard type');

      // Check Steps Field
      final stepsField = getTextField('bugStepsField');
      expect(stepsField.textCapitalization, TextCapitalization.sentences, reason: 'Steps should capitalize sentences');
      expect(stepsField.keyboardType, TextInputType.multiline, reason: 'Steps should have multiline keyboard type');
      ...
      await tester.enterText(find.byKey(const ValueKey('bugDescriptionField')), 'Some bug description');
      await tester.pump();
