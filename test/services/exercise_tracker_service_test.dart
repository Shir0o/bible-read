...
void main() {
  ...
  group('ExerciseTrackerService', () {
    ...
    test('upsertChallenge creates challenge document with timestamps',
        () async {
    ...
    test('recordDailyAmount increments totals and reports goal completion',
        () async {
    ...
    test('fetchChallengeSummaries reports goal state for multiple challenges',
        () async {
