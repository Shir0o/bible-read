...
const List<String> bookOrder = [
  ...
  'Job', 'Psalm', 'Proverbs', 'Ecclesiastes', 'Song of Songs', 'Isaiah', 'Jeremiah', 'Lamentations', 'Ezekiel', 'Daniel',
...
void main() {
  ...
  final plan = {
    ...
    "description": "Read through the entire Bible with 4 Old Testament chapters and 1 New Testament chapter daily.",
