...
import '../skeletons/book_tracker_skeleton.dart';

class BookTrackerView extends StatefulWidget {
  ...
  @override
  State<BookTrackerView> createState() => _BookTrackerViewState();
}

class _BookTrackerViewState extends State<BookTrackerView>
  ...
  Widget build(BuildContext context) {
    ...
    final achievementService = AchievementService(firestore: widget.firestore);
        ...
        child: StreamBuilder<Set<String>>(
          ...
          builder: (context, snapshot) {
            ...
            return SkeletonLoader(
              ...
              skeleton: const BookTrackerSkeleton(),
